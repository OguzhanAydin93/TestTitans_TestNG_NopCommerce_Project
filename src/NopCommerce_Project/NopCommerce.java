...
public class NopCommerce extends BaseDriver {
    ...
    @Test(dataProvider ="basarisizGiris",groups = {"Login Test"})
        ...
        if (
            ...
            Assert.assertTrue(elements.alert1.getText().toLowerCase().contains("wrong"));
        } else if (email.equals("techno+1@gmail.com") && Password.equals("123456")) {
            Assert.assertTrue(elements.confirmLogin.getText().contains("My account"));
